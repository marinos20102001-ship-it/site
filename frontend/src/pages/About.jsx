        ...
        <div className="px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-6">
            ...
            <h1 className="font-serif-display text-4xl md:text-5xl lg:text-6xl text-slate-900 leading-tight">
              Πάνω από δεκαπέντε χρόνια εμπειρίας στη λογιστική.
            </h1>
            <p className="mt-7 text-slate-600 leading-relaxed">
              Το DM Accounting δραστηριοποιείται στον χώρο της λογιστικής και φοροτεχνικής υποστήριξης
              με σταθερή παρουσία και μακρόχρονη συνεργασία με επιχειρήσεις κάθε μεγέθους και ιδιώτες.
              Συνδυάζουμε την κλασική επαγγελματική γνώση με τις πιο σύγχρονες ψηφιακές πρακτικές,
              ώστε οι πελάτες μας να έχουν πάντα πλήρη εικόνα των οικονομικών τους.
            </p>
